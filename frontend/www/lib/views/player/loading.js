(function(App) {
    ...
    var Loading = Backbone.Marionette.ItemView.extend({
        ...
        initialize: function() {
            ...
            _.bindAll(this, "onStateUpdate");
            this.listenTo(this.model, 'change:state', this.onStateUpdate);
            this.listenTo(this.model, 'change:streamInfo', this.onStateUpdate);
        },
        ...
        onStateUpdate: function() {
            ...
            if(state === 'downloading') {
              //this.listenTo(stateModel.get('streamInfo'), 'change:downloaded', this.onProgressUpdate);
              this.onProgressUpdate(this.model.get('streamInfo'));
            }
        },

        onProgressUpdate: function(streamInfo) {
